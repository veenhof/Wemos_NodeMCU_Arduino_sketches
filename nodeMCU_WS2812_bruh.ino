/*
  ...
  UPDATE 04 Feb 2018 by DavePeg     - Set LED pins to output to prevent dull blue glow on power up/reset
...
#define wifi_ssid "mySSID" //type your WIFI information inside the quotes
#define wifi_password "mywifiPW"
#define mqtt_server "MymqttIP"
#define mqtt_user "MymqttUN" 
#define mqtt_password "MymqttPW"
...
#define OTApassword "MyOTAPW" // change this to whatever password you want to use when you upload OTA
int OTAport = 8266;
...
#define CONFIG_DEFAULT_FLASH_LENGTH 10
// Number of seconds for one transition in colorfade mode
#define CONFIG_COLORFADE_TIME_SLOW 5
#define CONFIG_COLORFADE_TIME_FAST 2
...
void setup() {
  ...
  pinMode(redPin,OUTPUT); //fixes dull glow on power up
